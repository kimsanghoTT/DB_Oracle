...
CREATE TABLE TB_DEPARTMENT2 (
   ...
   COMMENT ON COLUMN "KH_T"."TB_DEPARTMENT2"."DEPARTMENT_NO" IS '학과 번호';
   COMMENT ON COLUMN "KH_T"."TB_DEPARTMENT2"."DEPARTMENT_NAME" IS '학과 이름';
   COMMENT ON COLUMN "KH_T"."TB_DEPARTMENT2"."CATEGORY" IS '계열';
   COMMENT ON COLUMN "KH_T"."TB_DEPARTMENT2"."OPEN_YN" IS '개설 여부';
   COMMENT ON COLUMN "KH_T"."TB_DEPARTMENT2"."CAPACITY" IS '정원';
...
CREATE TABLE TB_STUDENT2 (
   ...
   COMMENT ON COLUMN "KH_T"."TB_STUDENT2"."STUDENT_NO" IS '학생 번호';
   COMMENT ON COLUMN "KH_T"."TB_STUDENT2"."DEPARTMENT_NO" IS '학과 번호';
   COMMENT ON COLUMN "KH_T"."TB_STUDENT2"."STUDENT_NAME" IS '학생 이름';
   COMMENT ON COLUMN "KH_T"."TB_STUDENT2"."STUDENT_SSN" IS '학생 주민번호';
   COMMENT ON COLUMN "KH_T"."TB_STUDENT2"."STUDENT_ADDRESS" IS '학생 주소';
   COMMENT ON COLUMN "KH_T"."TB_STUDENT2"."ENTRANCE_DATE" IS '입학 일자';
   COMMENT ON COLUMN "KH_T"."TB_STUDENT2"."ABSENCE_YN" IS '휴학 여부';
   COMMENT ON COLUMN "KH_T"."TB_STUDENT2"."COACH_PROFESSOR_NO" IS '지도 교수 번호';
------------------------------------------------------------------------
CREATE TABLE TB_CLASS2 (
   ...
   COMMENT ON COLUMN "KH_T"."TB_CLASS2"."CLASS_NO" IS '과목 번호';
   COMMENT ON COLUMN "KH_T"."TB_CLASS2"."DEPARTMENT_NO" IS '학과 번호';
   COMMENT ON COLUMN "KH_T"."TB_CLASS2"."PREATTENDING_CLASS_NO" IS '선수 과목 번호';
   COMMENT ON COLUMN "KH_T"."TB_CLASS2"."CLASS_NAME" IS '과목 이름';
   COMMENT ON COLUMN "KH_T"."TB_CLASS2"."CLASS_TYPE" IS '과목 구분';
-------------------------------------------------------------------------
CREATE TABLE TB_CLASS_PROFESSOR2(
   ...
   COMMENT ON COLUMN "KH_T"."TB_CLASS_PROFESSOR2"."CLASS_NO" IS '과목 번호';
   COMMENT ON COLUMN "KH_T"."TB_CLASS_PROFESSOR2"."PROFESSOR_NO" IS '교수 번호';
--------------------------------------------------------------------------
CREATE TABLE TB_PROFESSOR2(
    ...
    COMMENT ON COLUMN "KH_T"."TB_PROFESSOR2"."PROFESSOR_NO" IS '교수 번호';
    COMMENT ON COLUMN "KH_T"."TB_PROFESSOR2"."PROFESSOR_NAME" IS '교수 이름';
    COMMENT ON COLUMN "KH_T"."TB_PROFESSOR2"."PROFESSOR_SSN" IS '교수 주민번호';
    COMMENT ON COLUMN "KH_T"."TB_PROFESSOR2"."PROFESSOR_ADDRESS" IS '교수 주소';
    COMMENT ON COLUMN "KH_T"."TB_PROFESSOR2"."DEPARTMENT_NO" IS '학과 번호';
-----------------------------------------------------------------------
CREATE TABLE TB_GRADE2(
    ...
    COMMENT ON COLUMN "KH_T"."TB_GRADE2"."TERM_NO" IS '학기 번호';
    COMMENT ON COLUMN "KH_T"."TB_GRADE2"."CLASS_NO" IS '과목 번호';
    COMMENT ON COLUMN "KH_T"."TB_GRADE2"."STUDENT_NO" IS '학생 번호';
    COMMENT ON COLUMN "KH_T"."TB_GRADE2"."POINT" IS '학점';
