...
WHERE E.DEPT_CODE = D.DEPT_ID AND E.JOB_CODE = J.JOB_CODE AND SUBSTR(E.EMP_NO, 1, 1) = 7 AND SUBSTR(E.EMP_NAME, 1, 1) = '전';
...
-- 보너스 포인트가 없는 직원들 중에서 직급코드가 J4~7인 직원들의 이름, 직급명, 급여
SELECT E.EMP_NAME, J.JOB_NAME, E.SALARY FROM EMPLOYEE E, JOB J
WHERE E.JOB_CODE = J.JOB_CODE AND E.JOB_CODE IN ('J4', 'J5', 'J6','J7');
...
SELECT E.EMP_ID, E.EMP_NAME, NVL(D.DEPT_TITLE, '소속 없음'), J.JOB_NAME, E.HIRE_DATE FROM EMPLOYEE E, DEPARTMENT D, JOB J
WHERE E.DEPT_CODE = D.DEPT_ID AND E.JOB_CODE = J.JOB_CODE
AND E.HIRE_DATE = (SELECT MIN(E.HIRE_DATE) FROM EMPLOYEE E WHERE E.DEPT_CODE = D.DEPT_ID) 
AND E.ENT_YN ='N' ORDER BY E.HIRE_DATE;
