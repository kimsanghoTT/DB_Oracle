...
INSERT INTO EMPLOYEE2 VALUES (230, '이성민', '910808-8901234','lee_sm@or.kr' ,'01089012345', 'D8','J3','S4', 3800000, 0.2, 207, '22/01/15', NULL, 'N');
...
INSERT INTO EMPLOYEE2 VALUES (235, '최수민', '960404-4567890','choi_sm@or.kr' ,'01045678901', 'D13','J3','S2', 3300000, 0.1, 212, '27/06/20', NULL, 'N');
...
UPDATE employee2 SET SALARY = SALARY+SALARY*0.1, BONUS = BONUS+0.05 WHERE DEPT_CODE = 'D1';
...
UPDATE employee2 SET ent_yn = 'N', hire_date = TO_DATE('2023', 'yyyy');
...
UPDATE employee2 SET email = replace(email, 'or.kr', 'example.com'), phone = '011-xxxx-xxxx';
